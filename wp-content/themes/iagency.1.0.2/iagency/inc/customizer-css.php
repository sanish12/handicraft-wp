 ...
 * @package iAgency
 */
if( !function_exists( 'iagency_custom_css' ) ) :
	/*
	 * Function For Custom CSS
	 *
	 *
	 */
	function iagency_custom_css() { ?>
				    	...
				    	<?php endif; ?>		
				    	<?php if(get_theme_mod('iagency_slider_section_enable')): ?>
...
#header.normal .slicknav_nav a:hover{
	color:<?php echo esc_attr(get_theme_mod('iagency-theme-color', '#222222')); ?>;
}
...
button, input[type="button"], input[type="reset"], input[type="submit"]{
	background: <?php echo esc_attr(get_theme_mod('iagency-theme-color', '#222222')); ?>;
}
#header .nav li a::after,
#portfolio .portfolio-nav ul li span::before,
#clients.section{
	border-top-color:<?php echo esc_attr(get_theme_mod('iagency-theme-color', '#222222')); ?>;
}
#blog .blog-head{
	border-bottom-color:<?php echo esc_attr(get_theme_mod('iagency-theme-color', '#222222')); ?>;
}
...
#contact .form-group textarea:hover{
	border-color:<?php echo esc_attr(get_theme_mod('iagency-theme-color', '#222222')); ?>;
}
...
#header.sticky .slicknav_btn {
    background: <?php echo esc_attr(get_theme_mod('iagency-theme-color', '#222222')); ?>;
		...
		<?php } endif;
add_action( 'wp_footer', 'iagency_custom_css');
