 ...
 */
function ithemer_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function ithemer_sanitize_css( $css ) {
 ...
 */
function ithemer_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function ithemer_sanitize_email( $email, $setting ) {
 ...
 */
function ithemer_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function ithemer_sanitize_html( $html ) {
 ...
 */
function ithemer_sanitize_image( $image, $setting ) {
 ...
 */
function ithemer_sanitize_nohtml( $nohtml ) {
 ...
 */
function ithemer_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function ithemer_sanitize_number_range( $number, $setting ) {
 ...
 */
function ithemer_sanitize_select( $input, $setting ) {
 ...
 */
function ithemer_sanitize_url( $url ) {
 ...
 * @return int
 */
function ithemer_sanitize_category($input){
	$output=intval($input);
	return $output;
}
 ...
 */
class Ithemer_Customize_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      <span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
         <select <?php echo $this->link(); ?>>
            <?php
              printf('<option value="%s" %s>%s</option>', '', selected($this->value(), '', false),__('Select', 'ithemer') );
             ?>
